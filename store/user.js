export default {
  ...
  state: () => ({
    ...
    redirectInfo: null, //重定向对象,对象形式：object 对象 { openType, from }
  }),
  //方法
  mutations: {
    updateAddress(state, address) { //1.更新用户地址
      ...
      this.commit(
      'm_user/saveAddressToStorage'); //2.通过 this.commit() 方法，调用 m_user 模块下的 saveAddressToStorage 方法将 address 对象持久化存储到本地
    },
    ...
    updateRedirectInfo(state, info) { //更新重定向对象的信息
